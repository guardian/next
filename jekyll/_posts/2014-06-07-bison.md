---
layout: article
title: "Adventures in content:<br />Antarctic Rescues to European Bison"
author: cantlin
hidden: true
...
Recently a new term has joined the Guardian newsroom's menagerie of jargon.

It was already home to pixies, super pixies, muggies, mini-bentos, bentos, snaps, slot rules and shuffle showcases. Lore known only to the wizened masters of digital production. Collectively, these names form an elaborate hazing ritual that ensure new starters are not able to contribute meaningfully for at least the first three months of their employ.

Only for a few weeks though have attentive visitors to the newsroom been able to hear sub-editors, purposefully striding across the floor, asking *"Can someone get me a* ***bison*** *on this piece?"*

## Return of the European Bison

*Bisoning* got its name in May from a [wonderful article](http://www.theguardian.com/environment/2014/may/21/-sp-european-bison-europe-romania-carpathian-mountains) by Guardian environment editor [Adam Vaughan](http://www.theguardian.com/profile/adam-vaughan).
...
The code that caused the Antarctica article to behave differently to everything else on the site was what we call a "<a href="http://en.wikipedia.org/wiki/Hack_(computer_science)#In_computer_science">hack</a>". Nothing to do with cyber-terrorism, just a word for some ugly engineering thrown together quickly for a one off job. The features it introduced only worked on that one page, and you needed a developer sitting next to you to change them.

<img src="/assets/images/bison/layout.png" style="width:100%;margin:40px auto 5px auto;" />

<div style="color:#999;font-size:15px;padding:0 0 10px 0;">Element "weighting" allows the journalist or sub-editor to embed images, videos and interactive components at variable sizes throughout the copy.</div>
